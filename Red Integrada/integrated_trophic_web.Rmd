---
title: "Integrated trophic web expl"
author: "Mitch Porter"
...
#from "Kortsch, S.; Frelat, R.; Pecuchet, L.; Olivier, P.; Putnis, I.; Bonsdorff, E.; Ojaveer, H.; Jurgensone, I.; Strake, S.; Rubene, G.; Kruze, E. and Nordström, M. (2022). Introduction to food webs metrics: the Gulf of Riga case study. https://rfrelat.github.io/BalticFoodWeb.html":
...
#boxplots
boxplot(tl~SE_num,data=ES_list, xlab="Servicio Ecosistémico", ylab="Nivel Trófico")
boxplot(conn~SE_num,data=ES_list, xlab="Servicio Ecosistémico", ylab="Cantidad de Conexiones")
```
...
plot_ES_troph <- function(g,vertexLabel=FALSE,vertexSizeFactor=5,vertexSizeMin=5,tk=FALSE,modules=FALSE,lMat=NULL,weights=NA,community_obj=NULL, bpal= NULL,
  ...
  V(g)$size <- ifelse(V(g)$vertextype > 20, 15, log10(deg)*vertexSizeFactor+vertexSizeMin)
  V(g)$frame.color <- NA
  V(g)$color <- "orange"
 ...
 V(g)$color <- ifelse(V(g)$vertextype > 20, "darkcyan", 
...
plot_ES_troph_ES1 <- function(g,vertexLabel=FALSE,vertexSizeFactor=5,vertexSizeMin=5,tk=FALSE,modules=FALSE,lMat=NULL,weights=NA,community_obj=NULL, bpal= NULL,
  ...
  deg <- degree(g, mode="all") 
  V(g)$size <- ifelse(V(g)$vertextype == 27, 15, log10(deg)*vertexSizeFactor+vertexSizeMin)
  V(g)$frame.color <- NA
  V(g)$color <- "orange"
 ...
 V(g)$color <- ifelse(V(g)$vertextype == 27, "darkcyan",
...
plot_ES_troph_ES2 <- function(g,vertexLabel=FALSE,vertexSizeFactor=5,vertexSizeMin=5,tk=FALSE,modules=FALSE,lMat=NULL,weights=NA,community_obj=NULL, bpal= NULL,
  ...
  deg <- degree(g, mode="all") 
  V(g)$size <- ifelse(V(g)$vertextype == 26, 15, log10(deg)*vertexSizeFactor+vertexSizeMin)
  V(g)$frame.color <- NA
  V(g)$color <- "orange"
 ...
 V(g)$color <- ifelse(V(g)$vertextype == 26, "darkcyan",
...
plot_ES_troph_ES3 <- function(g,vertexLabel=FALSE,vertexSizeFactor=5,vertexSizeMin=5,tk=FALSE,modules=FALSE,lMat=NULL,weights=NA,community_obj=NULL, bpal= NULL,
  ...
  deg <- degree(g, mode="all") 
  V(g)$size <- ifelse(V(g)$vertextype == 21, 15, log10(deg)*vertexSizeFactor+vertexSizeMin)
  V(g)$frame.color <- NA
  V(g)$color <- "orange"
 ...
 V(g)$color <- ifelse(V(g)$vertextype == 21, "darkcyan",
...
plot_ES_troph_ES4 <- function(g,vertexLabel=FALSE,vertexSizeFactor=5,vertexSizeMin=5,tk=FALSE,modules=FALSE,lMat=NULL,weights=NA,community_obj=NULL, bpal= NULL,
  ...
  deg <- degree(g, mode="all") 
  V(g)$size <- ifelse(V(g)$vertextype == 22, 15, log10(deg)*vertexSizeFactor+vertexSizeMin)
  V(g)$frame.color <- NA
  V(g)$color <- "orange"
 ...
 V(g)$color <- ifelse(V(g)$vertextype == 22, "darkcyan",
                      ifelse(V(g)$vertextype == 11, "cadetblue3",
                        ifelse(V(g)$tl < .71, "grey80", 
                         ifelse(V(g)$tl < 1.4, "grey74",
                            ifelse(V(g)$tl < 2.1, "grey68", 
...
plot_ES_troph_ES5 <- function(g,vertexLabel=FALSE,vertexSizeFactor=5,vertexSizeMin=5,tk=FALSE,modules=FALSE,lMat=NULL,weights=NA,community_obj=NULL, bpal= NULL,
  ...
  deg <- degree(g, mode="all") 
  V(g)$size <- ifelse(V(g)$vertextype == 23, 15, log10(deg)*vertexSizeFactor+vertexSizeMin)
  V(g)$frame.color <- NA
  V(g)$color <- "orange"
 ...
 V(g)$color <- ifelse(V(g)$vertextype == 23, "darkcyan",
...
plot_ES_troph_ES6 <- function(g,vertexLabel=FALSE,vertexSizeFactor=5,vertexSizeMin=5,tk=FALSE,modules=FALSE,lMat=NULL,weights=NA,community_obj=NULL, bpal= NULL,
  ...
  deg <- degree(g, mode="all") 
  V(g)$size <- ifelse(V(g)$vertextype == 25, 15, log10(deg)*vertexSizeFactor+vertexSizeMin)
  V(g)$frame.color <- NA
  V(g)$color <- "orange"
 ...
 V(g)$color <- ifelse(V(g)$vertextype == 25, "darkcyan",
...
plot_ES_troph_ES7 <- function(g,vertexLabel=FALSE,vertexSizeFactor=5,vertexSizeMin=5,tk=FALSE,modules=FALSE,lMat=NULL,weights=NA,community_obj=NULL, bpal= NULL,
  ...
  deg <- degree(g, mode="all") 
  V(g)$size <- ifelse(V(g)$vertextype == 24, 15, log10(deg)*vertexSizeFactor+vertexSizeMin)
  V(g)$frame.color <- NA
  V(g)$color <- "orange"
 ...
 V(g)$color <- ifelse(V(g)$vertextype == 24, "darkcyan",
